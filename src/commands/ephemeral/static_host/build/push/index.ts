 ...
 */
function generateBuildName(date: Date = new Date()): string {
...
export default class EphemeralStaticHostBuildPush extends BaseCommand {
...
`,
  ...
  async run(): Promise<void> {
    const {args, flags} = await this.parse(EphemeralStaticHostBuildPush)
