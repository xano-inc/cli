...
export default class EphemeralDelete extends BaseCommand {
  ...
  static description = 'Delete an ephemeral tenant permanently. This destroys all associated infrastructure and cannot be undone.'
  static examples = [
    `$ xano ephemeral delete e4f2-9ab1-xyz1
Are you sure you want to delete tenant e4f2-9ab1-xyz1? This action cannot be undone. (y/N) y
Deleted tenant e4f2-9ab1-xyz1
`,
    `$ xano ephemeral delete e4f2-9ab1-xyz1 --force
Deleted tenant e4f2-9ab1-xyz1
`,
    `$ xano ephemeral delete e4f2-9ab1-xyz1 -f -o json`,
  ]
